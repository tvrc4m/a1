...
<script>
    ...
    export default {
        ...
        methods:{
            editRule(rule){
                this.$router.push({name:"gov_rule_edit",params:{id:rule.id}})
            },
            doDel(rule){
            ...
            setRule(rule){
                this.$router.push({name:"gov_rule_permission",params:{cid:this.company_id,id:rule.id}})
            },
            changePage(page){
        ...
        mounted(){
            ...
            getCompany(this.company_id).then(data=>{
                ...
                this.breadcrumbs.push({
                    name: "权限管理",
                    route:{name:"gov_rule",params:{id:this.company_id}}
                })
            })
        }
    }
