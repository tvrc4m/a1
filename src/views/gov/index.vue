                        ...
                        <table class="table m-0 table-striped table-bordered dataTable no-footer">
                            ...
                            <tbody>
                                <tr v-for="(company,index) in data" :key="index">
                                    ...
                                    <!-- <td>{{company.sort}}</td> -->
                                    <td>
                                        <button type="button" class="btn btn-white btn-xs waves-effect waves-light m-r-10" @click="$router.push({name:'gov_rule',params:{cid:company.id}})">角色列表</button>
                                        <button type="button" class="btn btn-white btn-xs waves-effect waves-light m-r-10" @click="$router.push({name:'gov_user',params:{cid:company.id}})">用户列表</button>
                                    </td>
                                    <td>
